...
public class ResponseHandler {
	...
	public boolean isTenpaySign() {
		...
		// 算出摘要
//		String enc = Util.getCharacterEncoding(this.request, this.response);
		String sign = Digest.MD5(sb.toString(), Digest.Cipher.HEX).toLowerCase();
	...
	public void setUriEncoding(String uriEncoding) throws UnsupportedEncodingException {
		if (!"".equals(uriEncoding.trim())) {
			...
			// 编码转换
			String enc = Util.getCharacterEncoding(request, response);
