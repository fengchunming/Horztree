...
public class Signature {
	...
	public static String getSign(Object o) throws IllegalAccessException {
		...
		result = Digest.MD5(result, Digest.Cipher.HEX).toUpperCase();
		Util.log("Sign Result:" + result);
		return result;
	}

	public static String getSignParam(Map<String, String> map) {
		String param = serialParam(map);
		String sign = Digest.MD5(param + "key=" + Config.getKey(), Digest.Cipher.HEX).toUpperCase();
		return param + "sign=" + sign;
	}

	private static String serialParam(Map<String, String> map) {
		ArrayList<String> list = new ArrayList<>();
	...
	public static String getSign(Map<String, String> map) {
		String result = serialParam(map) + "key=" + Config.getKey();
		result = Digest.MD5(result, Digest.Cipher.HEX).toUpperCase();
		return result;
	}
	...
	//
	// return Digest.MD5(signStr, Digest.Cipher.HEX).toUpperCase();
	//
	// }
	//
	// public static boolean VerifySignature(String content, String sign, String
	// md5Key) {
	// String signStr = content + "&key=" + md5Key;
	// String calculateSign = Digest.MD5(signStr,
	// Digest.Cipher.HEX).toUpperCase();
	// String tenpaySign = sign.toUpperCase();
	// return tenpaySign.equals(calculateSign);
	// }
