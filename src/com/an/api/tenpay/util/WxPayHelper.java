...
public class WxPayHelper {
    ...
    public String CreateNativeUrl(String productid) {
        HashMap<String, String> nativeObj = new HashMap<>();
        nativeObj.put("appid", Config.getAppid());
        nativeObj.put("product_id", productid);// URLEncoder.encode(productid, "utf-8"));
...
//    }
    ...
    public String Unifiedorder(String device_info, String out_trade_no, String body, String total_fee, String product_id, TRADE_TP type) {

        HashMap<String, String> nativeObj = new HashMap<>();
        nativeObj.put("appid", Config.getAppid());
        nativeObj.put("mch_id", Config.getMchid());
        nativeObj.put("device_info", device_info);// URLEncoder.encode(productid, "utf-8"));
        nativeObj.put("nonce_str", Util.CreateNoncestr());//
        nativeObj.put("time_stamp", Long.toString(new Date().getTime() / 1000));//
        nativeObj.put("body", body);
        nativeObj.put("out_trade_no", out_trade_no);//Digest.MD5("1211", Digest.Cipher.HEX)
