...
public class UserController {
	...
	@Transactional
	public User update(@RequestBody User user) throws BadRequestException {
		if (userDao.save(user) != 1) {
			throw new BadRequestException("保存失败！");
		} else {
	...
	public Collection<Map<String, String>> loadUserKV() throws BadRequestException {
		return userDao.selectKV();
	}

	@RequestMapping(value = "/kv/purchaser", method = RequestMethod.GET)
	public Collection<Map<String, String>> loadPurchaserKV() throws BadRequestException {
		return userDao.selectKV();
	}

	@RequestMapping(value = "/kv/staff", method = RequestMethod.GET)
	public Collection<Map<String, String>> loadStaffKV() throws BadRequestException {
		return userDao.staffKV();
	}

	@RequestMapping(value = "/user/isExistUserName", method = RequestMethod.GET)
	@ResponseBody
	public boolean isExistUserName(@RequestParam(value = "userName") String userName, @RequestParam(value = "id") Integer id) throws BadRequestException {
