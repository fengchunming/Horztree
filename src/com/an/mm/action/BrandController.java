...
public class BrandController {
	...
	public Brand load(@PathVariable("id") int id) throws BadRequestException {
		return brandDao.selectOne(id);
	}

	@RequestMapping(value = "/brand", method = RequestMethod.POST)
	public Brand insert(@RequestBody Brand brand) throws BadRequestException {
	...
	public Brand update(@RequestBody Brand brand) throws BadRequestException {
